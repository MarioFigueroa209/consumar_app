...
//
//     final spCreateDamageReportListModel = spCreateDamageReportListModelFromJson(jsonString);

import 'dart:convert';

SpCreateDamageReportListModel spCreateDamageReportListModelFromJson(
        String str) =>
    SpCreateDamageReportListModel.fromJson(json.decode(str));

String spCreateDamageReportListModelToJson(
        SpCreateDamageReportListModel data) =>
    json.encode(data.toJson());

class SpCreateDamageReportListModel {
  SpCreateDamageReportListModel({
    this.jornada,
    this.fecha,
  ...
  factory SpCreateDamageReportListModel.fromJson(Map<String, dynamic> json) =>
      SpCreateDamageReportListModel(
