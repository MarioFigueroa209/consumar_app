...
class SupervisionEmbarquePage extends StatefulWidget {
  ...
  @override
  State<SupervisionEmbarquePage> createState() =>
      _SupervisionEmbarquePageState();
}

class DatosSupervisionEmbarque {
  DatosSupervisionEmbarque({this.cod, this.bulto});

  String? cod;
  String? bulto;
}

class _SupervisionEmbarquePageState extends State<SupervisionEmbarquePage> {
  final TextEditingController qrCodigoController = TextEditingController();

  final TextEditingController descripcionController = TextEditingController();

  List<DatosSupervisionEmbarque> listDatosSupervisionEmbarque =
      <DatosSupervisionEmbarque>[
    DatosSupervisionEmbarque(
      cod: "231313",
      bulto: "Bowl Botton",
    )
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text("SUPERVISIÓN EMBARQUE"),
      ),
          ...
          child: Column(children: [
            ...
            SizedBox(
              ...
              child: ListView.builder(
                  ...
                  itemCount: listDatosSupervisionEmbarque.length,
