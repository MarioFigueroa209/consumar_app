...
class RecepcionAlmacenIngreso extends StatefulWidget {
  const RecepcionAlmacenIngreso({super.key});

  @override
  State<RecepcionAlmacenIngreso> createState() =>
      _RecepcionAlmacenIngresoState();
}

class ListBultoTransporte {
  ListBultoTransporte({this.id, this.fotoBultoTransporte, this.urlFoto});

  int? id;
  File? fotoBultoTransporte;
  String? urlFoto;
}

class _RecepcionAlmacenIngresoState extends State<RecepcionAlmacenIngreso> {
  File? imageBultoIngreso;
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      width: 150,
                      height: 150,
                      child: imageBultoIngreso != null
                          ? Image.file(imageBultoIngreso!,
  ...
  Future pickBultoTransporte(ImageSource source) async {
    try {
      ...
      setState(() => this.imageBultoIngreso = imageTemporary);
